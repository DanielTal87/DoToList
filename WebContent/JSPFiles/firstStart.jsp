...
<h1>
	<i class="fa fa-list-ol h1Icon" ria-hidden="true"></i> My To-Do List
</h1>
<body>
					...
					<form method="get"
						...
						<div class="formgroup moveRightInp">
							<input type="email" title="Password enter a valid email address"
								...
								placeholder="Email.." name="email" size="25" />
						</div>
				...
				<div class="modal-body">
					...
					<div class="formgroup">
							userName: <input type="text" value=""
								name="userNameAdmin" /><br />
						</div>
						<div class="formgroup">
							password: <input type="text" value="" name="passwordAdmin" /><br />
						</div>
