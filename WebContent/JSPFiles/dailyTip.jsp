...
<body>
	<jsp:useBean id="tip" scope="session"
		class="com.hit.javaBeans.DailyTip" />
	<jsp:setProperty name="tip" property="*" />

	<button id="dayTip" class="button hidden" type="button"
		data-toggle="modal" data-target="#dailyTip">Update User</button>
			...
			<div class="modal-content">
				...
				<form method="get"
					...
					<div class="modal-body">
						<div class="formgroup">
							<input type="hidden"
								value="<%=session.getAttribute("username")%>" name="username" /><br />
						</div>
						<div class="formgroup">
							<input type="hidden"
								value="<%=session.getAttribute("password")%>" name="password" /><br />
						</div>
						<p>
							<%
